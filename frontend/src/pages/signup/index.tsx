...
export default function SignUp() {
  ...
  return (
       ...
       <div className={styles.containerCenter}>
          <Image className="logo" src={logoImg} alt="logo Nathan Pizzas" width="265" height="230"/>
          ...
          <div className={styles.login}>
            <h1>Criando sua conta</h1>
              ...
              <Link href="/" legacyBehavior><a className={styles.text}>Já possui uma conta? Faça login!</a></Link>
          </div>
       </div>
       </>
  )
