...
export default function Product({categoryList}: CategoryProps){
    ...
    async function handleRegister(event: FormEvent){
        ...
        try{
            ...
            if(name === '' || price === '' || desctiption === '' || imageAvatar === null){
    ...
    return(
        <>
            <Head>
                <title>Novo produto - Nathan Pizzas</title>
            </Head>
            <div>
                <Header/>
                    <main className={styles.container}>
                        ...
                        <form className={styles.form} onSubmit={handleRegister}>
                            ...
                            <textarea placeholder="Descreva seu produto..." className={styles.input} value={desctiption} onChange={(e) => setDescription(e.target.value)} />
